...
public class LifeFootball {
    public static void main(String[] args) {
        ...
        if (selectedProduct != null) {
            ...
            System.out.println("1. Delivery by Mail");
            System.out.println("2. Delivery by Courier");
            ...
            switch (deliveryChoice) {
                case 1:
                    DeliveryByMailFactory mailFactory = new DeliveryByMailFactory();
                    delivery = mailFactory.createDelivery();
                    break;
                case 2:
                    DeliveryBYCourierFactory courierFactory = new DeliveryBYCourierFactory();
                    delivery = courierFactory.createDelivery();
                    break;
                case 3:
                    DeliveryInStoreFactory selfPickupFactory = new DeliveryInStoreFactory();
                    delivery = selfPickupFactory.createDelivery();
                    break;
                default:
                    System.out.println("Invalid delivery choice.");
                    return;
            }

            double deliveryCost = delivery.getDeliveryCost();
            double totalCost = selectedProduct.getPrice() + deliveryCost;

            System.out.println("Delivery Cost: " + deliveryCost + " kzt");
